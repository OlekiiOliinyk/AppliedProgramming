...
public class DroidAssasin extends BaseDroid{
    ...
    public void criticalAttack(BaseDroid obj){
        ...
        if (this.getChanceCrit() >= chance){
            System.out.println(" ритичний удар " + this.getName() + " по б≥йцю " + obj.getName() + " пройшов!!!");
            kill(obj);
        }
        else{
            System.out.println(" ритичний удар " + this.getName() + " по б≥йцю " + obj.getName() + " не пройшов");
        }
    }
